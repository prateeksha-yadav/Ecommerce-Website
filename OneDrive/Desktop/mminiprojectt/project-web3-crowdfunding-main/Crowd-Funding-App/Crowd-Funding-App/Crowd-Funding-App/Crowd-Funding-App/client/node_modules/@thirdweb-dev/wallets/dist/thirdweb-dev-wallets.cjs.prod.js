...
var evm_wallets_magicAuth_dist_thirdwebDevWalletsEvmWalletsMagicAuth = require('../evm/wallets/magic-auth/dist/thirdweb-dev-wallets-evm-wallets-magic-auth.cjs.prod.js');
...
require('./classPrivateFieldGet-ee0bcee0.cjs.prod.js');
require('./tw-connector-180d18e7.cjs.prod.js');
require('eventemitter3');
require('../evm/wallets/base/dist/thirdweb-dev-wallets-evm-wallets-base.cjs.prod.js');
require('./abstract-221871d8.cjs.prod.js');
require('ethers');
require('./storage-97213a4f.cjs.prod.js');
require('localforage');
require('ethers-aws-kms-signer');
...
exports.MagicAuthWallet = evm_wallets_magicAuth_dist_thirdwebDevWalletsEvmWalletsMagicAuth.MagicAuthWallet;
