 ...
 * @twfeature DirectListings
 */
export declare function useCancelDirectListing(contract: RequiredParam<MarketplaceV3>): import("@tanstack/react-query").UseMutationResult<Omit<{
    receipt: import("@ethersproject/abstract-provider").TransactionReceipt;
    data: () => Promise<unknown>;
 ...
 * @twfeature EnglishAuctions
 */
export declare function useCancelEnglishAuction(contract: RequiredParam<MarketplaceV3>): import("@tanstack/react-query").UseMutationResult<Omit<{
    receipt: import("@ethersproject/abstract-provider").TransactionReceipt;
    data: () => Promise<unknown>;
}, "data">, unknown, BigNumberish, unknown>;
/**
