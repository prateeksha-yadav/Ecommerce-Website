...
import { ConnectorNotFoundError, UserRejectedRequestError, ResourceUnavailableError } from '@wagmi/core';
...
class MetaMaskConnector extends InjectedConnector {
  ...
  async connect() {
    ...
    try {
      ...
      let account = null;
      if (_classPrivateFieldGet(this, _UNSTABLE_shimOnConnectSelectAccount) && this.options?.shimDisconnect && !(await getConnectorStorage().getItem(this.shimDisconnectKey))) {
